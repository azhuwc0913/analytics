...
var changeUserNicknameFn = function(options){
    var orgName = options.orgName || '';
    var appName = options.appName || '';
    var appKey = options.appKey || '';
    if(!orgName && !appName && appKey){
    ...
    var url = options.https ? 'https://a1.easemob.com' : 'http://a1.easemob.com';
    var apiUrl = options.apiUrl || url;
    var restUrl = apiUrl + '/' + orgName + '/' + appName + '/users/'+options.username;
...
Easemob.im.Helper.changeUserNickname = changeUserNicknameFn;
})(jQuery)
}
